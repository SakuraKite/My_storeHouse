...
#define AUTH_INFO	"version=2018-10-31&res=products%2F7Kr0k6XBVi%2Fdevices%2Fwendu&et=2526321266&method=md5&sign=mQDL6Q3IgMG7TedDhyqqBg%3D%3D"
...
unsigned char MqttOnenet_Savedata(char *t_payload)
{
	...
	sprintf(t_json, json, (float)44.8);
